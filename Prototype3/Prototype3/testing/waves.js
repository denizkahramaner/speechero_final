var wave = function()
{
	...
	{
		var motionX = Math.sin(animationT)*animationX*0.5;
			motionX = 100;

		animationT += 0.1;
		pointers = [ [( ( motionX / 200 ) * CANVAS_WIDTH ) / QUALITY,
					( ( animationY / 200 ) * CANVAS_WIDTH ) / QUALITY ],

					[( ( (motionX+1) / 200 ) * CANVAS_WIDTH ) / QUALITY,
					( ( (animationY+1) / 200 ) * CANVAS_WIDTH ) / QUALITY ],
	...
	this.animate = function(x, time)
	{
		userInteraction = true;
		var tweenSmoothness = 1000/16;
		window.setInterval( this.tweenFunction, tweenSmoothness );
	}.bind(this)
